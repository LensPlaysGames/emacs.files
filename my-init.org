...
** Treesit FUNCompiler language syntax highlighting

#+begin_src emacs-lisp :mkdirp yes :tangle my-init.el
  (setq tree-sitter-load-path '("d:/Programming/treesitter/tree-sitter-un/bld"))
  (setq treesit-extra-load-path '("d:/Programming/treesitter/tree-sitter-un/bld"))
#+end_src
