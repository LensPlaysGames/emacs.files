...
#+begin_src emacs-lisp :mkdirp yes :tangle my-init.el
  ...
  (setq tree-sitter-load-path   '("d:/Programming/treesitter/tree-sitter-un/bld" "~/.tree_sitter/bin"))
  (setq treesit-extra-load-path '("d:/Programming/treesitter/tree-sitter-un/bld" "~/.tree_sitter/bin"))
